...
getCMHresP <- function(model, dir, pc_path, nclust, resolution, nperm = c(1), cores = 1) {
    ...
    matrix.data <- lapply(nclust, function(x) readMatrix(model, dir, resolution, pc_path, x))
